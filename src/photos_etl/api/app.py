...
app = FastAPI(title="Photos ETL Pipeline", version="1.0.0")
...
def _execute_pipeline_in_background() -> None:
    ...
    BackgroundTasks) quanto pelo scheduler (Passo 20), garantindo que
    ambos os gatilhos disparem exatamente a mesma execução.
    """
